        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '3rem', alignItems: 'flex-start', marginBottom: '3rem' }}>
          ...
          <div style={{ flex: '1 1 300px' }}>
            ...
            <div style={{ display: 'inline-flex', alignItems: 'center', gap: '0.4rem', background: '#fef3c7', color: '#d97706', padding: '0.3rem 0.85rem', borderRadius: '20px', fontSize: '0.8rem', fontWeight: 700, marginBottom: '1rem' }}>
              {/* 🔗  */}
              <svg xmlns="http://www.w3.org/2000/svg" height={20} width={20} viewBox="0 0 512 512"><g strokeWidth="0"><path d="M386.5 84.6c-8.3 1.8-15.3 4.3-23 8.2-7.5 3.9-11 6.6-21.1 16.5-6.7 6.5-12.7 13.1-13.4 14.7-3.4 8.3 6.3 17.1 14.3 12.9 1.2-.7 7.4-6.2 13.8-12.4 13.2-12.8 19.6-16.5 32.4-19.2 31.9-6.5 62.5 18.7 62.8 51.6.1 9.6-1.6 16.7-6.1 25.6-3.2 6.4-9.4 12.9-77.1 80.6l-73.6 73.7-8.5 4.1c-10.8 5.2-20.1 6.8-30.9 5.2-23.6-3.5-41.8-22-45.3-46-1-6.6-.9-9.2.5-16.2 2.6-13.1 6.3-19.5 19.2-32.8 6.2-6.4 11.7-12.6 12.4-13.8 4.2-8.1-4.8-17.5-13.3-13.9-1.7.7-8.6 7-15.3 13.9-11.1 11.4-12.6 13.5-17.2 22.9-6.4 13.2-8.6 23.5-7.8 36.8.7 11.3 2.6 19.1 7.1 28.5 9.2 19.5 27.3 34.4 48.6 40.1 9 2.4 28.2 2.5 37 .1 8.7-2.4 18-6.8 25.4-12.1 3.4-2.5 39-37.4 79.1-77.8 53.7-53.8 73.9-74.8 76.4-79 8.1-13.9 11.7-28.5 10.8-43.3-.7-11.5-2.7-19-7.7-29-12.5-25.4-37.8-40.7-66.9-40.4-5.8.1-11.5.3-12.6.5" /><path d="M233.5 144.6c-8.9 2-18.5 6-26.1 10.9-6.1 4-138.6 135-150.9 149.3-7 8.1-13.4 20.1-16.2 30.2-2.7 10.2-2.5 29.3.5 39 7.7 24.5 25.1 42.6 48.7 50.6 6.4 2.2 10.4 2.8 20.1 3.2 14.7.5 24.5-1.6 37.4-8 7.3-3.7 10.5-6.2 22.3-17.8 12.7-12.4 13.9-13.8 14-17.2.1-4.9-1.9-8.4-6-10.3-5.8-2.8-8.4-1.4-21.9 11.6-13.2 12.8-19.6 16.8-30.6 19.4C97 412 68.7 394.9 61 367c-1.9-6.7-1.7-20.5.4-27.5 4.3-14.5 2.6-12.6 81-91 54.5-54.5 74.6-73.9 78.9-76.4 7.9-4.6 17.4-7.1 27.2-7.1 15.2 0 26.3 4.7 37.2 15.6 8.2 8.1 12.4 15.8 14.8 27 1.8 8.7 1.8 12.1 0 20.9-2.6 12.1-6.5 18.6-19.6 32.1-6.7 6.9-12.1 13.3-12.5 14.8-1.7 7 4.7 14.3 11.6 13.2 2.9-.4 5.9-3 17-14.3 11.6-11.9 14.1-15 17.8-22.3 6.5-13 8.6-22.8 7.9-37.5-.3-7-1.2-14.3-2.2-17.5-4.5-14.3-14.1-28.7-25.3-37.5-6.9-5.5-19.5-11.9-27.7-14.1-8.8-2.3-25.5-2.7-34-.8" /></g></svg>
              Linked Product
            </div>

            <h1 style={{ fontFamily: 'Poppins, sans-serif', fontSize: 'clamp(1.7rem, 3vw, 2.4rem)', fontWeight: 800, color: 'var(--brand-primary)', margin: '0 0 1rem', lineHeight: 1.2 }}>
              {product.name}
            </h1>
